...
namespace Identifikacija__Identify_App_
{
    public partial class Form7 : Form
    {
        ...
        {
            this.Size = new Size(1217, 762); //1201 699
            ...
            g.DrawString("ISSUE DATE: " + DateTime.Now.ToString("dd.MM.yyyy.") + "\nVALID UNTIL: " + DateTime.Now.AddYears(2).ToString("dd.MM.yyyy.") + "\nCITY: " + odRad.Mesto.ToUpper(), new Font("Consolas", 10, FontStyle.Bold), Brushes.White, 570, 535);
            pictureBox1.Invalidate();
        }
    }
}
